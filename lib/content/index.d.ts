...
declare const ContentBase: {
    ...
    Footer: ({ className, style, reduceWidth, reduceDom, children, ...props }: FooterProps) => React.DetailedReactHTMLElement<{
        defaultChecked?: boolean | undefined;
        defaultValue?: string | number | readonly string[] | undefined;
        suppressContentEditableWarning?: boolean | undefined;
        suppressHydrationWarning?: boolean | undefined;
...
/** 搜索的包裹层 */
export declare const SearchContent: React.ForwardRefExoticComponent<ContentProps & React.RefAttributes<unknown>>;
export declare const Footer: ({ className, style, reduceWidth, reduceDom, children, ...props }: FooterProps) => React.DetailedReactHTMLElement<{
    defaultChecked?: boolean | undefined;
    defaultValue?: string | number | readonly string[] | undefined;
    suppressContentEditableWarning?: boolean | undefined;
    suppressHydrationWarning?: boolean | undefined;
